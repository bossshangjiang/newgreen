...
@Entity
@Table(name="irr_with_heat_item")
public class Irr_with_heat_item {
    @Id
    @GeneratedValue(strategy= GenerationType.AUTO)
    private Integer IRR_WITH_HEAT_ITEM_ID;
    ...
    public Double getHEAT_INCOME() {
        return HEAT_INCOME;
    }

    public void setHEAT_INCOME(Double HEAT_INCOME) {
        this.HEAT_INCOME = HEAT_INCOME;
    }
    ...
    public Integer getIRR_WITH_HEAT_ITEM_ID() {
        return IRR_WITH_HEAT_ITEM_ID;
    }

    public void setIRR_WITH_HEAT_ITEM_ID(Integer IRR_WITH_HEAT_ITEM_ID) {
        this.IRR_WITH_HEAT_ITEM_ID = IRR_WITH_HEAT_ITEM_ID;
    }

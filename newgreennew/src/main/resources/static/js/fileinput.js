    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFooter = '<div class="file-thumbnail-footer">\n' +
                '    <div class="file-footer-caption" title="{caption}">{caption}<br><br><br><input type="text" title="{caption}" name="cc" value="abcd"/><br/>{size}</div>\n' +
        ...
        _getSize: function (bytes) {
            ...
            if (typeof func === 'function') {
                ...
                if (size === 0) {
                    ...
                    out = (size / Math.pow(10240, i)).toFixed(2) * 1 + ' ' + sizes[i];
                }
            }

// 分别获取count页面表的值 传给后台 跳转第三页文件上传index
    ...
    $.ajax({
        ...
        success:function(data){
            if(data!="aaa"){
                // 跳转至文件上传
                alert("上传成功");
                var link ="index.html" + '?pname='+data;
...
function uploadcount3() {
    ...
    $.ajax({
        type: 'POST',
        url: '/uploadirr_without_heat_debt',
        data: count,
        success: function (data) {
            if (data != "aaa") {
                console.log("success");
...
function uploadcount5() {
    ...
    $.ajax({
        type: 'POST',
        url: '/uploadirr_without_heat_item',
        data: count,
        success: function (data) {
            if (data != "aaa") {
                console.log("success");
